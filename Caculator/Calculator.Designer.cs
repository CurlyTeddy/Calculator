namespace Caculator
{
    partial class Calculator
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Four.Tag = new Number(this.Four.Text);
            this.Five.Tag = new Number(this.Five.Text);
            this.Six.Tag = new Number(this.Six.Text);
