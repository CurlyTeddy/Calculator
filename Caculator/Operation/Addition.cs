...
namespace Caculator
{
    ...
    /// </summary>
    public class Addition : BaseOperation, IButton, IDoubleOperation
    {
        /// <summary>
        ...
        public Addition(string buttonText)
        {
            Content = buttonText;
        }
        ...
        {
            SymbolWorks(Content);
            GlobalVariables.LowOperator.Add(new Addition(GlobalVariables.ListOperand.Count));
        }
